class {{collectionName.pascalCase()}}Service extends TurboCollectionService<{{collectionObjectName.pascalCase()}}, {{collectionName.pascalCase()}}Api> {
  ...
  @override
  FutureOr<Stream<List<{{collectionObjectName.pascalCase()}}>>> Function(User user) get stream => throw UnimplementedError();
